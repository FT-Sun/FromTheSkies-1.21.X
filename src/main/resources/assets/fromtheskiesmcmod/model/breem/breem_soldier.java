...
public class breem_villager<T extends breem> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		.texOffs(16, 9).addBox(-1.5F, -0.5F, -1.0F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 13.0F, -1.0F));
		...
		.texOffs(0, 13).addBox(-2.0F, 9.0F, -0.25F, 4.0F, 1.0F, 0.5F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 13.0F, 0.75F));
