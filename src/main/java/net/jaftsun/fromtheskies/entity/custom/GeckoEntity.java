...
public class GeckoEntity extends Animal {
    ...
    public @Nullable AgeableMob getBreedOffspring(ServerLevel serverLevel, AgeableMob otherParent) {
        ...
        GeckoEntity geckoParent = (GeckoEntity) otherParent;
        baby.setVariant(Util.getRandom(new GeckoVariant[]{this.getVariant(), geckoParent.getVariant()}, this.random));
    ...
    private void setupAnimationStates() {
        if(this.idleAnimationTimeout <= 0) {
            this.idleAnimationTimeout = 80; // 80 ticks = 4 seconds * 20 ticks a second
